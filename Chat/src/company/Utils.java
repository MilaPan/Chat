...
import java.util.Set;
    ...
    // Decodes and prints Error Codes generated by GroupServlet when managing Chat rooms
    public static void printGroupErrorCodes(int res) {
        switch (res) {
            case 200: {
                System.out.println("User(s) added to room");
                break;
            }
            case 401: {
            ...
            case 400: {
                System.out.println("ERROR! Room name is already taken by a user");
                break;
            }
            case 403: {
                System.out.println("ERROR! Must be in the room to invite");
                break;
            }
            default: {
